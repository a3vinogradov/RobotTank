...
#define IBUS_MAXCHANNELS 14 // My TX only has 10 channels, no point in polling the rest
...
class FlySkyReceiver
{
  private:
    ...
    uint16_t rcValue[IBUS_MAXCHANNELS]={1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500};
